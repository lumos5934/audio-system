...
#### Audio Player
컴포넌트 형태로 사용 가능한 Audio Player 를 제공합니다. 사용방법은 동일하며 FollowTransform 체크를 통해 오디오가 따라다닐 수 있습니다. <br>

`GameObject / Aduio / AudioManager`<br> 
<img width="484" height="244" alt="image" src="https://github.com/user-attachments/assets/beb7d7ae-f738-44ad-9a14-941d468106cd" />
<img width="290" height="155" alt="image" src="https://github.com/user-attachments/assets/248ea664-0aa3-475b-981e-64eec7b8dec4" />
